            ...
            <div class="col-md-9 content">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Sửa lớp học</li>
                    </ol>
                </nav>
                ...
                <div class="card form-card">
                    <div class="card-header bg-warning text-dark">
                        <h5 class="mb-0">Cập nhật thông tin lớp học</h5>
                    </div>
                    <div class="card-body">
                        <form action="index.php?controller=lophoc&action=edit&id=<?= $lopHoc['id'] ?>" method="POST">
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    <label for="ma_lop" class="form-label">Mã lớp học <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" id="ma_lop" name="ma_lop" value="<?= htmlspecialchars($lopHoc['ma_lop']) ?>" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" id="ten_lop" name="ten_lop" value="<?= htmlspecialchars($lopHoc['ten_lop']) ?>" required>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" id="mo_ta" name="mo_ta" rows="3"><?= htmlspecialchars($lopHoc['mo_ta'] ?? '') ?></textarea>
                            ...
                            <div class="row mb-3">
                                <div class="col-md-6">
                                    ...
                                    <input type="date" class="form-control" id="ngay_bat_dau" name="ngay_bat_dau" 
                                           value="<?= (!empty($lopHoc['ngay_bat_dau']) && $lopHoc['ngay_bat_dau'] != '0000-00-00') ? date('Y-m-d', strtotime($lopHoc['ngay_bat_dau'])) : '' ?>">
                                </div>
                                <div class="col-md-6">
                                    <label for="ngay_ket_thuc" class="form-label">Ngày kết thúc</label>
                                    <input type="date" class="form-control" id="ngay_ket_thuc" name="ngay_ket_thuc"
                                           value="<?= (!empty($lopHoc['ngay_ket_thuc']) && $lopHoc['ngay_ket_thuc'] != '0000-00-00') ? date('Y-m-d', strtotime($lopHoc['ngay_ket_thuc'])) : '' ?>">
                                </div>
                            </div>
